...
logSummary() {
    echo ""
        ...
        echo "Gateway - http://bank.zyllion.zyllion.nip.io"
        echo "Zipkin - http://zipkin.istio-system.zyllion.nip.io"
        echo "Grafana - http://grafana.istio-system.zyllion.nip.io"
        echo "Kiali - http://kiali.istio-system.zyllion.nip.io"
        echo "#####################################################"
}
...
default() {
    ...
    kubectl label namespace zyllion istio-injection=enabled --overwrite=true
    kubectl apply -f bank-${suffix}/
