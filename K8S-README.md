...
```
$ docker image tag bank latishmk/bank
$ docker push latishmk/bank
$ docker image tag customer latishmk/customer
$ docker push latishmk/customer
$ docker image tag product latishmk/product
$ docker push latishmk/product
```
...
```
$ kubectl get svc bank -n zyllion
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n zyllion
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n zyllion
```
